...
echo '\n'$bound5' максимум (по качеству) для подсчёта вес как w_i = (s_+ - s_-) / deg_i'
python3 completenesscheck.py '../results/neutral_cut/posD'$ftag$bound5'.txt' '../results/neutral_cut/neuD'$ftag$bound5'.txt' '../results/neutral_cut/negD'$ftag$bound5'.txt' '../../testing/500_pos.txt' '../../testing/500_neu.txt' '../../testing/500_neg.txt' '../results/transformed'$find'.txt'
