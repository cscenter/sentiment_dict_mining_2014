...
print("Mean: " + str(sum(pairs_graph.vertex_properties["attraction"].a) / (len(pairs_graph.vertex_properties["attraction"].a))))
...
n, bins, patches = plt.hist(ver_attractions.a, 2500, facecolor='g')
mids = []
for i in range(0, (len(bins) - 1)):
    mids.append((bins[i + 1] + bins[i]) / 2)
plt.plot(mids, n, 'ro')
plt.xlabel('attraction')
plt.ylabel('Probability')
plt.title('Histogram of attraction')
plt.grid(True)
plt.show()
d = "x"
cols = ['r', 'g', 'b', 'y', 'k']
